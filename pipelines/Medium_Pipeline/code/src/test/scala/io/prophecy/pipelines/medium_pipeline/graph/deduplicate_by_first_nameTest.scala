...
class deduplicate_by_first_nameTest extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/deduplicate_by_first_name/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/deduplicate_by_first_name/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/deduplicate_by_first_name/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/deduplicate_by_first_name/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed = io.prophecy.pipelines.medium_pipeline.graph
      .deduplicate_by_first_name(context, dfIn)
