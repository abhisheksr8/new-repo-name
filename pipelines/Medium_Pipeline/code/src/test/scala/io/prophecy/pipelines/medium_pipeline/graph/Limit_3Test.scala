...
class Limit_3Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Limit_3/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Limit_3/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Limit_3/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Limit_3/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.medium_pipeline.graph.Limit_3(context, dfIn)
