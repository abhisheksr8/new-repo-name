...
class Reformat_10_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/pm_shared_graph/Reformat_10_1/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/pm_shared_graph/Reformat_10_1/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/pm_shared_graph/Reformat_10_1/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/pm_shared_graph/Reformat_10_1/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.medium_pipeline.graph.pm_shared_graph.Reformat_10_1(
