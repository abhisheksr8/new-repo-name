...
class SQL_DONOT_CHANGETest extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn0 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/expressions_sg/SQL_DONOT_CHANGE/in0/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/expressions_sg/SQL_DONOT_CHANGE/in0/data/unit_test_.json",
      "in0"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/expressions_sg/SQL_DONOT_CHANGE/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/expressions_sg/SQL_DONOT_CHANGE/out/data/unit_test_.json",
      "out"
    )
    ...
    val res = assertDFEquals(dfOut.select("c1"),
