...
import io.prophecy.pipelines.small_pipeline.graph.reformatted_columns_1.config.{
  Config => reformatted_columns_1_Config
}
import io.prophecy.pipelines.small_pipeline.graph.subgraph_reformat_5.config.{
  Config => subgraph_reformat_5_Config
}
import io.prophecy.pipelines.small_pipeline.graph.Subgraph_4.config.{
