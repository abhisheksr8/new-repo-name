...
class reformat_columnsTest extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformat_columns/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformat_columns/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformat_columns/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformat_columns/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed = io.prophecy.pipelines.medium_pipeline.graph
      .reformat_columns(context, dfIn)
