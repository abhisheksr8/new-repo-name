package io.prophecy.pipelines.medium_pipeline.graph.Subgraph_4
...
class Reformat_8Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Subgraph_4/Reformat_8/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Subgraph_4/Reformat_8/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Subgraph_4/Reformat_8/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/Subgraph_4/Reformat_8/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.medium_pipeline.graph.Subgraph_4.Reformat_8(
        io.prophecy.pipelines.medium_pipeline.graph.Subgraph_4.config
