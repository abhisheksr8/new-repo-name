...
class UNIT_TESTS_REFORMAT_GEMTest extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/UNIT_TESTS_REFORMAT_GEM/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/UNIT_TESTS_REFORMAT_GEM/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/UNIT_TESTS_REFORMAT_GEM/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/UNIT_TESTS_REFORMAT_GEM/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed = io.prophecy.pipelines.medium_pipeline.graph
      .UNIT_TESTS_REFORMAT_GEM(context, dfIn)
