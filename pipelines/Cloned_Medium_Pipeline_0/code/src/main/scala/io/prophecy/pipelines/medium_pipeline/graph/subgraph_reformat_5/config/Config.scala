package io.prophecy.pipelines.medium_pipeline.graph.subgraph_reformat_5.config
...
import io.prophecy.pipelines.medium_pipeline.graph.subgraph_reformat_5.Subgraph_2.config.{
