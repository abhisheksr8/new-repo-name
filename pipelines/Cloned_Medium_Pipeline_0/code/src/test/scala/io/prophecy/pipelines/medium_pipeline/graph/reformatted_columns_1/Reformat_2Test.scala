...
class Reformat_2Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformatted_columns_1/Reformat_2/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformatted_columns_1/Reformat_2/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformatted_columns_1/Reformat_2/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/reformatted_columns_1/Reformat_2/out/data/unit_test_.json",
      "out"
    )
