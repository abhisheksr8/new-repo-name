package io.prophecy.pipelines.medium_pipeline.graph.subgraph_reformat_5.Subgraph_2
...
class Reformat_5Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/subgraph_reformat_5/Subgraph_2/Reformat_5/in/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/subgraph_reformat_5/Subgraph_2/Reformat_5/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/medium_pipeline/graph/subgraph_reformat_5/Subgraph_2/Reformat_5/out/schema.json",
      "/data/io/prophecy/pipelines/medium_pipeline/graph/subgraph_reformat_5/Subgraph_2/Reformat_5/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.medium_pipeline.graph.subgraph_reformat_5.Subgraph_2
        .Reformat_5(
          io.prophecy.pipelines.medium_pipeline.graph.subgraph_reformat_5.Subgraph_2.config
            .Context(context.spark,
                     context.config.subgraph_reformat_5.Subgraph_2
            ),
          dfIn
        )
