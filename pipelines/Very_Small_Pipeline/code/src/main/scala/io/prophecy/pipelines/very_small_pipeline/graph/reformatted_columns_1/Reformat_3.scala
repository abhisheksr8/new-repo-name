package io.prophecy.pipelines.very_small_pipeline.graph.reformatted_columns_1
...
import io.prophecy.pipelines.very_small_pipeline.graph.reformatted_columns_1.config.Context
