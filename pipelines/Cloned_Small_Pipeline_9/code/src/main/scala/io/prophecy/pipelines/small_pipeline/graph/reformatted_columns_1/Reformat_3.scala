package io.prophecy.pipelines.small_pipeline.graph.reformatted_columns_1
...
import io.prophecy.pipelines.small_pipeline.graph.reformatted_columns_1.config.Context
