...
@task_wrapper(task_id = "SM_IO_SCALA_BASIC_1_1")
def SM_IO_SCALA_BASIC_1_1(ti=None, params=None, **context):
    from datetime import timedelta
    from airflow.providers.databricks.operators.databricks import DatabricksSubmitRunOperator # noqa

    return DatabricksSubmitRunOperator(  # noqa
        task_id = "SM_IO_SCALA_BASIC_1_1",
        json = {
          "task_key": "SM_IO_SCALA_BASIC_1_1", 
          "new_cluster": {
