from performance_abhisheks_performance_scala_small_product_boundary_cloned_composer_small_job_2.utils import *

@task_wrapper(task_id = "SM_IO_SCALA_BASIC_1_2")
def SM_IO_SCALA_BASIC_1_2(ti=None, params=None, **context):
    from datetime import timedelta
    from airflow.providers.databricks.operators.databricks import DatabricksSubmitRunOperator # noqa

    return DatabricksSubmitRunOperator(  # noqa
        task_id = "SM_IO_SCALA_BASIC_1_2",
        json = {
          "task_key": "SM_IO_SCALA_BASIC_1_2", 
          "new_cluster": {
            ...
            "spark_conf": {
              "spark.prophecy.metadata.job.uri": "__PROJECT_ID_PLACEHOLDER__/jobs/Cloned_Composer_Small_Job_2", 
